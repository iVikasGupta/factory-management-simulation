  ...
  return (
    <Layout>
      <div className="p-8 max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Submit Decision</h1>
          <p className="text-gray-600 mt-1">Level {currentRound?.level || 1} - Round {currentRound?.round_number || 3}</p>
        </div>

        {submitted && (
          <div className="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center">
            <CheckCircle className="w-5 h-5 mr-2" />
            Decision submitted successfully! (Demo Mode)
          </div>
        )}
